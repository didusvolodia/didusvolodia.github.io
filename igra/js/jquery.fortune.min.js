(function ($) {
    $.fn.fortune = function (options) {
        ...
        fortune.spin = function (price, sub_price) {
            ...
            var bounceSpin = function () {
                var curPosition = Math.floor(getRotationDegrees(fortune)),
                    mod = Math.floor((curPosition + prices_delta * .5) % prices_delta), diff_position,
                    position_threshold = prices_delta / 5, distance_threshold = prices_delta / 10;
        ...
        var getRotationDegrees = function (obj) {
            ...
            if (matrix !== "none") {
                var angle, values = matrix.split("(")[1].split(")")[0].split(","), a = values[0], b = values[1], radians = Math.atan2(b, a);
                if (radians < 0) {
                    radians += 2 * Math.PI
                }
